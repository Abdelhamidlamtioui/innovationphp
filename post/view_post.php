<?php require "connexion_post.php" 
        ...
        <div class="solution_cards_box">
          <div class="solution_card mb-5">
            ...
            <div class="solu_description">
              <p>
              <?php echo $data['descriptionn']; ?>
              </p>
              <p><?php echo $data['author']; ?></p>
              <a href="update_post.php?id=<?php echo $data['id']; ?>"  class="read_more_btn btn">Update</a> <a href="delete_post.php?id=<?php echo $data['id']; ?>" class="btn">Delete</a>
            </div>
        </div>
        <?php endwhile; ?>
